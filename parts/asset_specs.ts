...
const ASSET_SPECS: Record<string, AssetSpec> = {
	...
	well_plate:           { defaultWidth: 18, labelWidth: 8,  },
	media_bottle:         { defaultWidth: 8,  labelWidth: 7,  },
	trypsin_bottle:       { defaultWidth: 7,  labelWidth: 8,  },
	ethanol_bottle:       { defaultWidth: 5,  labelWidth: 7,  },
	serological_pipette:  { defaultWidth: 3,  labelWidth: 8,  anchorYOffset: 0 },
	aspirating_pipette:   { defaultWidth: 3,  labelWidth: 8,  anchorYOffset: 0 },
	multichannel_pipette: { defaultWidth: 5,  labelWidth: 8,  anchorYOffset: 0 },
